...
import type { Question } from "@/landing/types/question.interface";
...
const Questions = ({ questions = questionsMock }: Props) => {
    return (
        <section className={styles.questions}>
            <SectionTitle>
                Preguntas <span className="cyan-text">Frecuentes</span>
            </SectionTitle>
